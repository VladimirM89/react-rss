...
const mockedPagination: PaginationInterface = {
  last_visible_page: 1026,
  has_next_page: true,
  current_page: 1,
  items: {
    count: 25,
...
const mockedCharacter: CharacterInterface = {
  mal_id: 1,
...
describe('CharactersInfo tests', () => {
  ...
  it('update detail character values when update is successed', () => {
    ...
    expect(
      reducer(prevState, updateSuccess({ data: [mockedCharacter], pagination: mockedPagination }))
    ).toEqual({
