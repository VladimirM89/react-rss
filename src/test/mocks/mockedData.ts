...
export const mockedCharactersData: Array<CharacterInterface> = [
  // {
  //   mal_id: 1,
...
export const mockedPagination: PaginationInterface = {
...
export const mockedCharacterData: CharacterInterface = {
  mal_id: 1,
