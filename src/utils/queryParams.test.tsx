...
describe('Test function that create currect query params', () => {
  it('Return correct values without q params', () => {
  ...
  it('Return correct values without page params', () => {
    const mockObj: SearchParams = {
      q: 'test',
      limit: '10',
    };
  ...
  it('Return correct values without limit params', () => {
    const mockObj: SearchParams = {
      q: 'test',
      page: '10',
    };
  ...
  it('Return correct values without page and limit params', () => {
    const mockObj: SearchParams = {
      q: 'test',
    };
    expect(customCreateSearchParams(mockObj)).toEqual({ q: 'test' });
  });
  it('Return correct values with limit less than 10', () => {
    const mockObj: SearchParams = {
      q: 'test',
      limit: '9',
    };
  ...
  it('Return correct values with limit more than 10 and less than 15, ', () => {
    const mockObj: SearchParams = {
      q: 'test',
      limit: '13',
    };
  ...
  it('Return correct values with limit more than 15 and less than 20, ', () => {
    const mockObj: SearchParams = {
      q: 'test',
      limit: '17',
    };
  ...
  it('Return correct values with limit more than 20 and less than 25, ', () => {
    const mockObj: SearchParams = {
      q: 'test',
      limit: '24',
    };
  ...
  it('Return correct values with limit more than 10 and less than 25, ', () => {
    const mockObj: SearchParams = {
      limit: '50',
    };
